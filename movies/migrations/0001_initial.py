    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.ManyToManyField(related_name='watch_items', to='movies.Genre')),
                ('title_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.titletype')),
            ],
        ),
    ]
